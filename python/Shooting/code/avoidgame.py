...
background = pygame.image.load(
    "D:/programes/py_workspace/Shooting/background/space.png")


character = pygame.image.load(
    "D:/programes/py_workspace/Shooting/character/spaceship.png")
...
enermy = pygame.image.load(
    "D:/programes/py_workspace/Shooting/character/enermy_ship.png")
enermy_size = enermy.get_rect().size
enermy_width = enermy_size[0]
enermy_height = enermy_size[1]
enermy_pos_x = random.randint(0, screen_width - enermy_width)
enermy_pos_y = -enermy_height
count = 0
enermy_speed = 5
    ...
    for event in pygame.event.get():
        ...
        if event.type == pygame.KEYUP:
            if event.key == pygame.K_LEFT or event.key == pygame.K_RIGHT:
                ...
                pos_y = 0
    enermy_pos_y += enermy_speed + count

    if enermy_pos_y > screen_height:
        count += 0.5
        enermy_pos_y = -enermy_height
        enermy_pos_x = random.randint(0, screen_width - enermy_width)
